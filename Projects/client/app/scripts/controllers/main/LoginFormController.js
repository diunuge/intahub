(function (module) {
    ...
    cloudPOS.ng.application.controller('LoginFormController', ['$scope', 'AuthenticationService', 'ResourceFactory', 'HttpService','$timeout', cloudPOS.controllers.LoginFormController]).run(function ($log) {
