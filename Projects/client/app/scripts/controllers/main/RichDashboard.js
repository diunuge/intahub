(function (module) {
    ...
    cloudPOS.ng.application.controller('RichDashboard', ['$scope', 'ResourceFactory', 'localStorageService', '$rootScope', '$location', cloudPOS.controllers.RichDashboard]).run(function ($log) {
