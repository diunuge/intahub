(function (module) {
    ...
    cloudPOS.ng.application.controller('ViewCheckerinboxController', ['$scope', 'ResourceFactory', '$routeParams', '$location', '$modal', cloudPOS.controllers.ViewCheckerinboxController]).run(function ($log) {
