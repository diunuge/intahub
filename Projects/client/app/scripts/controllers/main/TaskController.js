(function (module) {
    ...
    cloudPOS.ng.application.controller('TaskController', ['$scope', 'ResourceFactory', '$route', 'dateFilter', '$modal', '$location', cloudPOS.controllers.TaskController]).run(function ($log) {
