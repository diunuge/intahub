(function (module) {
    ...
    cloudPOS.ng.application.controller('ProfileController', ['$scope', 'localStorageService', 'ResourceFactory', '$modal', cloudPOS.controllers.ProfileController]).run(function ($log) {
